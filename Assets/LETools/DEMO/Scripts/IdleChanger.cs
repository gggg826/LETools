...
public class IdleChanger : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Box(new Rect(10, 10, 100, 90), "Select Style");
        if (GUI.Button(new Rect(20, 40, 80, 20), "Action"))
            Application.LoadLevel("XML");
        if (GUI.Button(new Rect(20, 70, 80, 20), "ARPose"))
            Application.LoadLevel("BINARY");
    }
